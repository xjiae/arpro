...
# MVTEC_CATEGORIES=("transistor" "cable" "capsule" "carpet" "grid" "hazelnut" "leather" "metal_nut" "pill" "screw" "tile" "toothbrush" "wood" "zipper" "bottle" )
...
#   CUDA_VISIBLE_DEVICES=2 python train_fixer.py --model diffusion --dataset mvtec --category $category --image_size 256 --num_epochs 100 --batch_size 2
   CUDA_VISIBLE_DEVICES=1 python run_eval.py --task exp1 --ad efficientad --dataset mvtec --category $category --image_size 256 --batch_size 8 --end 0.01
